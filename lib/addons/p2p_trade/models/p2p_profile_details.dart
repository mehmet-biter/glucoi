...
class P2PProfileDetails {
  ...
  // List<FeedbackList>? positiveFeedbackList;
  // List<FeedbackList>? negativeFeedbackList;
  int? positive;
  int? negative;
  ...
  factory P2PProfileDetails.fromJson(Map<String, dynamic> json) => P2PProfileDetails(
        ...
        // positiveFeedbackList: List<FeedbackList>.from(json["positive_feedback_list"].map((x) => FeedbackList.fromJson(x))),
        // negativeFeedbackList: List<dynamic>.from(json["negative_feedback_list"].map((x) => x)),
