...
class P2PAds {
  ...
  factory P2PAds.fromJson(Map<String, dynamic> json) => P2PAds(
        ...
        paymentMethodList: json["payment_method_list"] == null
            ? null
            : List<P2pPaymentInfo>.from(json["payment_method_list"].map((x) => P2pPaymentInfo.fromJson(x))),
...
class P2PAdsDetails {
  ...
  factory P2PAdsDetails.fromJson(Map<String, dynamic> json) => P2PAdsDetails(
        paymentMethods:
            json["payment_methods"] == null ? null : List<P2pPaymentInfo>.from(json["payment_methods"].map((x) => P2pPaymentInfo.fromJson(x))),
