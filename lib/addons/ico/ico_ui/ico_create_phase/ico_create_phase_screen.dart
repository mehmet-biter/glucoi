...
class _IcoCreatePhaseScreenState extends State<IcoCreatePhaseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final tHeight = MediaQuery.of(context).textScaleFactor > 1 ? (Dimens.btnHeightMain + 5) : Dimens.btnHeightMain;
    return Scaffold(
      body: BGViewMain(
        child: SafeArea(
            child: Padding(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                          vSpacer5(),
                          textAutoSizeKarla("Coin Currency".tr, fontSize: Dimens.regularFontSizeMid, textAlign: TextAlign.start),
                          Obx(() {
                            final list = _controller.currencyList.map((e) => e.name ?? "").toList();
                            return dropDownListIndex(
                                list, _controller.selectedCurrency.value, "Select".tr, (index) => _controller.selectedCurrency.value = index,
                                hMargin: 0);
                          }),
                          vSpacer10(),
                          ...
                          vSpacer10(),
                          textFieldWithSuffixIcon(
                              controller: titleEditController, hint: "Enter Phase Title".tr, labelText: "Phase Title".tr, height: tHeight),
                          vSpacer10(),
                          textFieldWithSuffixIcon(
                          ...
                          Row(children: [
                            Expanded(
                                child: InkWell(
                                    ...
                                    child: textFieldWithSuffixIcon(
                                        controller: TextEditingController(text: startDateStr), labelText: "Start Date".tr, isEnable: false))),
                            hSpacer5(),
                            Expanded(
                                child: InkWell(
                                    onTap: () => _openDatePicker(false),
                                    child: textFieldWithSuffixIcon(
                                        controller: TextEditingController(text: endDateStr), labelText: "End Date".tr, isEnable: false))),
                          ]),
                          vSpacer10(),
                          textFieldWithSuffixIcon(
                          ...
                          vSpacer10(),
                          textFieldWithSuffixIcon(
                              controller: videoEditController, hint: "Enter Video Link".tr, labelText: "Video Link".tr, height: tHeight),
                          vSpacer10(),
                          textFieldWithSuffixIcon(
                              controller: fbEditController, hint: "Enter Facebook Link".tr, labelText: "Facebook Link".tr, height: tHeight),
                          vSpacer10(),
                          textFieldWithSuffixIcon(
                              controller: twitEditController, hint: "Enter Twitter Link".tr, labelText: "Twitter Link".tr, height: tHeight),
                          vSpacer10(),
                          textFieldWithSuffixIcon(
                              controller: linkedEditController, hint: "Enter Linkedin Link".tr, labelText: "Linkedin Link".tr, height: tHeight),
                          vSpacer10(),
