                              ...
                              child: ListView(
                                ...
                                children: [
                                  ...
                                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                    Expanded(child: buttonRoundedMain(text: "Save Data".tr, onPressCallback: () => _checkAndSaveInfo(context))),
                                    hSpacer10(),
                                    Expanded(child: buttonRoundedMain(text: "Add Field".tr, onPressCallback: () => _addNewInfoInList())),
                                  ]),
                                  vSpacer10(),
                                ],
                              ),
...
class PhaseAdditionalInfoItemView extends StatelessWidget {
  ...
  _documentView(BuildContext context, PhaseAdditionalInfo info) {
