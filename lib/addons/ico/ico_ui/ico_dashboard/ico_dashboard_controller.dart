...
class IcoDashboardController extends GetxController {
  ...
  Future<void> icoTokenWithdrawRequest(double amount, String currencyType, String currencyTo, Function() onSuccess) async {
    showLoadingDialog();
    IcoAPIRepository().icoTokenWithdrawRequest(amount, currencyType, currencyTo).then((resp) {
      hideLoadingDialog();
