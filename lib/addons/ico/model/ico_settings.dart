...
class IcoLaunchpad {
  ...
  factory IcoLaunchpad.fromJson(Map<String, dynamic> json) => IcoLaunchpad(
        ...
        launchpadFirstTitle: json["launchpad_first_title"],
        launchpadFirstDescription: json["launchpad_first_description"],
        launchpadSecondTitle: json["launchpad_second_title"],
        launchpadSecondDescription: json["launchpad_second_description"],
        launchpadApplyToStatus: json["launchpad_apply_to_status"],
        launchpadWhyChooseUsText: json["launchpad_why_choose_us_text"],
        launchpadApplyToButtonText: json["launchpad_apply_to_button_text"],
