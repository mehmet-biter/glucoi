                ...
                Obx(
                  () => Expanded(
                    child: ListView(
                      ...
                      children: [
                        _topShareView(_controller.referralData.value.user?.userUniqueId ?? ''),
                        vSpacer20(),
                        ReferralWithdrawView(
                            wallet: _controller.referralData.value.referralWallet,
                            onWithdrawTap: () {
                              showModalSheetFullScreen(context, ReferralWithdrawProcessView(wallet: _controller.referralData.value.referralWallet));
                            }),
                        vSpacer20(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: textWithCopyButton(referral)),
              textAutoSizeTitle("Or".tr, fontSize: Dimens.regularFontSizeMid),
              hSpacer20(),
              buttonText("Share".tr, onPressCallback: () => shareText(referral))
            ],
          )
        ],
      ),
  ...
  Widget _referencesItemView(Referral referral) {
    return Column(
      ...
      children: [
        ...
        vSpacer5(),
        twoTextSpaceFixed('Email'.tr, referral.email ?? "", color: context.theme.primaryColorLight),
        vSpacer5(),
        twoTextSpace('Level'.tr, referral.level ?? ""),
        vSpacer5(),
