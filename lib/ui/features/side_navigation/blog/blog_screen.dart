                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                        ...
                        child: textAutoSizePoppins(formatDate(blog.publishAt, format: dateFormatMMMMDddYyy), color: context.theme.primaryColor)),
                  ],
                ),
              )
            ],
          ...
          child: Column(
            ...
            children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                hSpacer5(),
                textAutoSizePoppins(formatDate(blog.publishAt, format: dateTimeFormatDdMMMMYyyyHhMm), textAlign: TextAlign.end)
              ])
            ],
          ),
        ),
