...
class _SecurityScreenState extends State<SecurityScreen> {
  final _controller = Get.put(SecurityController());
      ...
      body: BGViewMain(
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              children: [
                appBarBackWithActions(title: "Security".tr),
                Expanded(
                  child: ListView(
                    shrinkWrap: true,
                    ...
                    children: [
                      Align(
                          ...
                          child: textAutoSizePoppins("Profile Security Status".tr, fontSize: Dimens.regularFontSizeExtraMid)),
                      vSpacer10(),
                      _basicSecurityView(),
                      vSpacer20(),
                      Align(
                          alignment: Alignment.centerLeft,
                          child: textAutoSizePoppins("Advanced Security".tr, fontSize: Dimens.regularFontSizeExtraMid)),
                      vSpacer10(),
  ...
  Widget _basicSecurityView() {
    return Obx(() {
      ...
      return Column(
        children: [
          _securityItemView(
              imagePath: AssetConstants.icGoogleAuthenticatorLogo,
