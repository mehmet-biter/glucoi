...
import 'currency_wallet_flutter_wave_deposit_view.dart';
...
class CurrencyWalletDepositScreenState extends State<CurrencyWalletDepositScreen> with TickerProviderStateMixin {
  ...
  @override
  void initState() {
    _controller.wallet.value = widget.wallet;
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      _controller.getFiatDepositData();
      _controller.getWalletDetails();
    });
  ...
  Widget _openPaymentView(int selected) {
    ...
    switch (methods?.paymentMethod) {
      ...
      case PaymentMethodType.flutterWave:
        return const CurrencyWalletFlutterWaveDepositView();
      default:
        return Container();
    }
  }
