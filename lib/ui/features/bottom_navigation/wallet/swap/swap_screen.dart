                    ...
                    Expanded(child: Obx(() {
                      ...
                      return ListView(
                        ...
                        children: [
                          ...
                          vSpacer20(),
                          twoTextSpace("From".tr, "${"Available".tr} ${coinFormat(fCoin.balance ?? fCoin.availableBalance)} ${fCoin.coinType ?? ""}"),
                          vSpacer5(),
                          textFieldWithWidget(
                          ...
                          vSpacer10(),
                          twoTextSpace("To".tr, "${"Available".tr} ${coinFormat(tCoin.balance ?? tCoin.availableBalance)} ${tCoin.coinType ?? ""}"),
                          vSpacer5(),
                          textFieldWithWidget(
