...
class WalletScreenState extends State<WalletScreen> {
  ...
  @override
  void initState() {
    if (TemporaryData.switchViewId != null) {
      int index = _controller.getTypeMap().keys.toList().indexWhere((element) => element == TemporaryData.switchViewId!);
      _controller.selectedTypeIndex.value = index;
      TemporaryData.switchViewId = null;
    }
    super.initState();
  }
  ...
  void _openActivityPage(String type) {
    ...
    getRootController().changeBottomNavIndex(4, false);
  }
}
