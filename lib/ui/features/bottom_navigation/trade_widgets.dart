        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              //     maxLine: 2, subMaxLine: 3, color: context.theme.primaryColorLight, fontSize: Dimens.regularFontSizeExtraMid),
              // vSpacer5(),
              twoTextSpaceFixed("Beneficiary".tr, bank.accountHolderName ?? "",
                  maxLine: 2, subMaxLine: 3, color: context.theme.primaryColorLight, fontSize: Dimens.regularFontSizeExtraMid),
              vSpacer5(),
              // twoTextSpaceFixed("Account holder address".tr, bank.accountHolderAddress ?? "",
              //     maxLine: 2, subMaxLine: 3, color: context.theme.primaryColorLight, fontSize: Dimens.regularFontSizeExtraMid),
              // vSpacer5(),
              twoTextSpaceFixed("Note".tr, bank.note ?? "",
                  maxLine: 2, subMaxLine: 5, color: context.theme.primaryColorLight, fontSize: Dimens.regularFontSizeExtraMid),
            ],
          ),
        )
      ],
