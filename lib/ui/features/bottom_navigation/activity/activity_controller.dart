...
class ActivityScreenController extends GetxController {
  ...
  Map<String, String> getTypeMap() {
    ...
    var map = {
      ...
      // HistoryType.swapBuyCrypto: "Buy Crypto History".tr,
      // HistoryType.swapSellCrypto: "Sell Crypto History".tr,
    ...
    APIRepository().getActivityList(loadedPage, type, search: query, isFiat: isFiat.value).then((resp) {
      ...
      if (resp.success) {
        ...
        if (listResponse != null) {
          ...
          List<dynamic> list = [];
          if ([HistoryType.swap, HistoryType.swapBuyCrypto, HistoryType.swapSellCrypto].contains(type)) {
