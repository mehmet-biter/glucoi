...
class Wallet {
  ...
  factory Wallet.fromJson(Map<String?, dynamic> json) => Wallet(
        ...
        minimumDeposit: makeDouble(json["minimum_deposit"]),
        maximumDeposit: makeDouble(json["maximum_deposit"]),
      );

  double getBalance() {
    return (availableBalance != null && availableBalance! > 0) ? availableBalance! : (balance ?? 0);
  }
}
...
class NetworkAddress {
  ...
  factory NetworkAddress.fromJson(Map<String, dynamic> json) => NetworkAddress(networkId: json["network_id"], address: json["address"]);
}
