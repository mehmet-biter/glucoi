...
class FiatHistory {
  ...
  factory FiatHistory.fromJson(Map<String, dynamic> json) => FiatHistory(
        ...
        walletId: json["wallet_id"],
        fromWalletId: json["from_wallet_id"],
        paymentMethodId: makeInt(json["payment_method_id"]),
        ...
        flutterWaveBankDetails: json["flutterwave_bank_details"],
        wallet: json["wallet"] == null ? null : Wallet.fromJson(json["wallet"]),
        bank: json["bank"] == null ? null : Bank.fromJson(json["bank"]),
        payment: json["payment"] == null ? null : PaymentMethod.fromJson(json["payment"]),
      );
}
...
class WalletCurrencyHistory {
  ...
  factory WalletCurrencyHistory.fromJson(Map<String, dynamic> json) => WalletCurrencyHistory(
        ...
        flutterWaveBankDetails: json["flutterwave_bank_details"],
        bank: json["bank"] == null ? null : Bank.fromJson(json["bank"]),
        payment: json["payment_method"] == null ? null : PaymentMethod.fromJson(json["payment_method"]),
        paymentStatus: json["payment_status"],
      );
}
