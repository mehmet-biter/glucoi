...
class CommonSettings {
  CommonSettings({
    ...
    this.evmApiSecret,
    this.navbar,
    this.blogSectionHeading,
    this.blogSectionDescription,
    this.supportEmail,
    this.messageForLostAuthenticator,
    this.minimumBalanceReferralWithdraw,
    this.dailyMaxWithdrawDepositStatus,
    this.dailyMaxWithdrawDepositAmount,
  });
  ...
  String? blogSectionHeading;
  String? blogSectionDescription;
  String? supportEmail;
  String? messageForLostAuthenticator;
  double? minimumBalanceReferralWithdraw;
  int? dailyMaxWithdrawDepositStatus;
  double? dailyMaxWithdrawDepositAmount;
  ...
  factory CommonSettings.fromJson(Map<String, dynamic> json) => CommonSettings(
        ...
        liveChatStatus: makeInt(json["live_chat_status"]),
        ...
        blogSectionHeading: json["blog_section_heading"],
        blogSectionDescription: json["blog_section_description"],
        supportEmail: json["support_email"],
        messageForLostAuthenticator: json["text_message_for_lost_authenticator_app"],
        minimumBalanceReferralWithdraw: makeDouble(json["minimum_balance_referral_withdraw"]),
        dailyMaxWithdrawDepositStatus: makeInt(json["daily_maximum_withdraw_deposit_status"]),
        dailyMaxWithdrawDepositAmount: makeDouble(json["daily_maximum_withdraw_deposit_amount"]),
      );
}
...
class LandingData {
  ...
  int? landingFirstSectionStatus;
  int? landingSecondSectionStatus;
  int? landingThirdSectionStatus;
  ...
  factory LandingData.fromJson(Map<String, dynamic> json) => LandingData(
        ...
        landingFirstSectionStatus: makeInt(json["landing_first_section_status"]),
        landingSecondSectionStatus: makeInt(json["landing_second_section_status"]),
        landingThirdSectionStatus: makeInt(json["landing_third_section_status"]),
      );
}
