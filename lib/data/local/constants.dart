...
class AssetConstants {
  ...
  static const icLogoTransparent = "${basePathIcons}icLogoTransparent.png";
  static const icLogoTransparentNoPadding = "${basePathIcons}icLogoTransparentNoPadding.png";
  ...
  static const icTopUp = "${basePathIcons}ic_top_up.png";
  ...
  static const icReceipt = "${basePathIcons}ic_receipt.png";
  static const icKyc = "${basePathIcons}ic_kyc.png";
...
class HistoryType {
  ...
  static const swapBuyCrypto = "swap_buy_crypto";
  static const swapSellCrypto = "swap_sell_crypto";
...
class PreferenceKey {
  ...
  static const isLocalAuthActive = "is_local_auth_active";
  static const isKycVerified = "is_kyc_verified";
}

class DefaultValue {
  static const int kPasswordLength = 6;
  static const int codeLength = 6;
  static const int userCodeLength = 10;
  ...
  static const bool showLanding = false;
...
class EnvKeyValue {
  ...
  static const kIntercomIOSKey = "intercomIOSKey";
  static const kIntercomAndroidKey = "intercomAndroidKey";
}
...
class KYCType {
  ...
  static const manual = 1;
  static const persona = 2;
  static const dojah = 4;
}

class BankType {
  static const manual = 0;
  static const flutterWave = 1;
}
